<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmUserManage.aspx.cs" Inherits="EducationV2.frmUserManag" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function btnAdd_onclick() {
            //window.open('frmUserEdit.aspx', 'newwindow', 'height=550,width=400,top=200,left=400,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no'); 
            self.location.href = 'frmUserEdit.aspx'; // input如果是submit类型，则该语句无效     
        }
    </script>
</head>
<body>
    ...
    <div class="systeminfo">
        ...
        &nbsp;<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="maintable">
                    <yyc:SmartGridView ID="gvUsersInDept" runat='server' AllowPaging="True" AllowSorting="True"
                        AutoGenerateColumns="False" CellPadding="4" Width="100%" DataKeyNames="F_ID"
                        OnPageIndexChanged="gvUsersInDept_PageIndexChanged" DataSourceID="odsUserInDept"
                        GridLines="None">
                        <Columns>
                            ...
                            <asp:BoundField DataField="F_ID" HeaderText="F_ID" SortExpression="F_ID" Visible="false" />
                            <asp:HyperLinkField DataNavigateUrlFields="F_ID" SortExpression="用户名" HeaderText="用户名"
                                Target="_self" DataTextField="用户名" DataNavigateUrlFormatString="frmUserEdit.aspx?id={0}" />
                            ...
                            <asp:BoundField DataField="用户身份" HeaderText="用户身份" SortExpression="用户身份" />
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="F_ID" DataNavigateUrlFormatString="frmUserDetail.aspx?id={0}"
                                HeaderText="个人详细信息" Target="_blank" Text="查看" />
                        </Columns>
                        <CascadeCheckboxes>
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="gvUsersInDept" EventName="PageIndexChanged" />
            </Triggers>
        </asp:UpdatePanel>
    </div>
    <asp:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" ConfirmText="确定删除所选择的用户"
        TargetControlID="btnDel">
    </asp:ConfirmButtonExtender>
    <asp:ObjectDataSource ID="odsUserInDept" runat="server" SelectMethod="GetUsersInDept"
