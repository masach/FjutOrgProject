<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmStaffDetail3.aspx.cs"
    Inherits="EducationV2.frmStaffDetail3" %>
...
<body>
    <div class="systeminfo">
        <div class="systitleline">
            <input id="Button1" type="button" value="保 存" onclick="savePage(3)"
                class="btn" />
        </div>
        <div class="maintable">
