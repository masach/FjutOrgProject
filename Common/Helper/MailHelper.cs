...
namespace Cmj_Common
{
    ...
    {
        public string _From = "mail@fengla.com";//默认发送邮件
        public string EmailHost = "25";//SMTP服务器
        public string EmailUserName = "123";//SMTP服务器
        public string EmailPassWord = "123456";//SMTP服务器
