<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmStaffDetail2.aspx.cs"
    Inherits="EducationV2.frmStaffDetail2" %>
...
<body>
    ...
    <div class="systeminfo">
        <div class="systitleline">
            <input id="Button1" type="button" value="保 存" onclick="savePage(2)" 
                class="btn" />
        </div>
        <div class="maintable">
